...
│   │   ├── datasets.js           # DB Grid Editör + Arapça klavye + API key yönetimi
│   │   ├── web-db.js             # Web modu: sql.js ile quran.db tarayıcıda okuma
...
|-------|-------|-----------|
| **0.43.7** | 2025-07-28 | Kok renk duzeltmesi + JSON DB yetkilendirme + degisiklik gecmisi |
