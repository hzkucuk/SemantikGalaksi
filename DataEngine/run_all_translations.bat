...
python generate_root_translations.py AIzaSyDecxO-gF5KFJF7XusYMcB3hQmKNkMH134 en
echo EN tamamlandi: %time%

echo.
echo [2/4] RU cevirisi basliyor...
python generate_root_translations.py AIzaSyDecxO-gF5KFJF7XusYMcB3hQmKNkMH134 ru
echo RU tamamlandi: %time%

echo.
echo [3/4] IT cevirisi basliyor...
python generate_root_translations.py AIzaSyDecxO-gF5KFJF7XusYMcB3hQmKNkMH134 it
echo IT tamamlandi: %time%

echo.
echo [4/4] ES cevirisi basliyor...
python generate_root_translations.py AIzaSyDecxO-gF5KFJF7XusYMcB3hQmKNkMH134 es
